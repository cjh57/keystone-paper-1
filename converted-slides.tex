...
%other words, meningitis is always cerebrospinal.---from adams & victor's
    ...
    \section{Introduction}
        ...
        \mct{I need to rework the following paragraph a bit to work with the numbers I have.}
