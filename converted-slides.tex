...
%other words, meningitis is always cerebrospinal.---from adams & victor's
    ...
    \section{Conclusion}
        ...
        \mtc{One of two current priorities, bang this out in skeleton form 1st
            \begin{itemize}
                \item 1st paragraph: main thesis in abbrev form, 3-5 sentences
                \item 2nd paragraph: many things would be good to know ...
                \item most important from public health perspective is ...
                \item from perspective of disease eco. most imp. for understanding key dynamics is ... \mcc{vertical and horizontal trans rates of KEYV (and other spp) by mosquito spp infected vertically and horizontally}\mtc{not getting deep into the weeds!}
            \end{itemize}
        }
\end{document}
