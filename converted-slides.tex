...
%other words, meningitis is always cerebrospinal.---from adams & victor's
    ...
    \section[Expected costs, given diseases]{Question 4: What is the expected cost of each acute disease state, conditional on experiencing it?}
        ...
        \subsection{Meningitis}
            As noted in section \ref{asdf}, viral meningitis is generally regarded as relatively benign. \mcc{Elaborate on potential counterarguments.}

            Moreover, even if the strictly physiological effects of the disease itself are limited, additional costs may incurred due to 
