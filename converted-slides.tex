    ...
    \label{transmission-dynamics}
        ...
        \subsection{Keystone Virus and its hosts}
            ...
            \subsubsection{Keystone Virus}
                Keystone virus was first isolated in 1962 in the Tampa Bay area during a St.\ Louis Encephalitis epidemic\cite{asdf}, and first identified as a distinct species in 1964\cite{bond1966california}. It is primarily transmitted by the floodwater mosquito \atl. \mcc{Mention \textit{infirmatus}}. Its point prevalence in mosquitos of that species has consistently been found to be approximately 0.003 across several surveys, conducted in different years\cite{watts1988maintenance,asdf}.\mcc{Watts only appears to give hard numbers for 1 year, but I know I've seen the same rough prevalence at least one elsewhere, and I think several.} The greatest amount of research on both vertebrate hosts and transmission dyanmics of KEYV was done in the Pokomoke Cypress Swamp in Maryland, between 1971 and 1985\cite{watts1988maintenance}.\mct{These are the dates I know research was ocurring in; I haven't seen explicit statements about start date or wrap-up, so it may be somewhat broader.} In that region, the primary vertebrate hosts of KEYV are rabbits and grey squirrels\cite{watts1988maintenance}. A smaller amount of research on the same subject, done in Florida, supports a major role for rabbits and grey squirrels as well.\cite{asdf} In addition, there is some evidence that cotton rats may also be important hosts in Florida\cite{jennings1970tamiami,taylor1971california}; cotton rats are not found as far North as the Pokomoke Swamp. In all of these primary hosts, KEYV appears to produce a 1--5 day viremia\cite{watts1988maintenance,jennings1968california}, with generally mild symptoms\cite{asdf}.
