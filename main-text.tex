...
%other words, meningitis is always cerebrospinal.---from adams & victor's
    ...
    %given time, let's tweak this; time will probably not exist
    Secondly, KEYV appears to have been more common than TVTV in Florida in that general period\cite{taylor1971california}. %more limited than i'd like (and a bit later, 65--67) but it will do
